...
function meet() {
  return (
    <div>
        ...
        <div className=' text-5xl flex' id="contact">
            <div className=' flex-initial w-9/12 bg-black h-screen  text-white  justify-center flex' >
            <p className='block mt-auto mb-auto  tracking-wider font-extralight p-5 ' style={{lineHeight:"50px"}}>
            ...
            <div className='flex-initial   bg-white text-4xl uppercase items-center justify-center flex flex-col text-center'>
              <h2 className='mb-10'> Let's Work together!! </h2>
      <form>
...
<input type='textarea' placeholder='How can we help?' className='w-3/4 bg-transparent text-black  border-collapse appearance-none p-2 py-4  placeholder:text-teal-500  focus:outline-none border-b border-teal-500 leading-tight' />
       <input type="submit" value="SEND IT!" data-wait="Please wait..." className=" w-3/4 submit-button-cf2 mt-10 ml-28 w-button block p-2 border border-black rounded-3xl hover:bg-black text-teal-500 hover:text-white "/>
      </form>
            </div>
